...
*The U.S. Office of Personnel Management (OPM) guidance reflects that as a result of the Supreme Court’s decision in United States v. Windsor, which struck down Section 3 of the Defense of Marriage Act (DOMA), legally married same-sex spouses are eligible for federal benefits, including those related to veterans' preference where spousal eligibility is a factor (e.g., derived preference), regardless of state of residency.*
...
38 U.S.C. § 4214 requires agencies to have a separate affirmative action program for disabled veterans. This includes:
